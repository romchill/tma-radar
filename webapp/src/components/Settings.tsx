  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <div className="hint">
          <b>Биржи читаются напрямую</b> — Kwork и FL.ru уже в списке, у их заказов
          есть бюджет и срок, но откликаться надо на самой бирже. <b>ВК даёт
          прямой контакт</b>: на стене группы пишут сами люди. Телеграм-каналы
          чаще перепечатывают те же биржи с задержкой. Чаты не читаются: у них
          нет веб-версии.
        </div>
      </div>
