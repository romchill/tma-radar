...
BUDGETS: list[tuple[str, int]] = [
    ...
    # Вилка считается по НИЖНЕЙ границе: платят по ней. У людей единица
    # измерения часто стоит только в конце — без этого заказ переоценивался
    # на целую ступень: виделась только вторая половина вилки.
    ("Нужен бот для записи. Бюджет: от 45 000 до 70 000 руб.", 14),
    ("Бот для магазина, от 10 до 30 тыс руб", 9),
    ("Мини-апп, От  100,000 ₽  до  200,000 ₽", 24),
    ("Простой бот, От  2,000 ₽  до  6,000 ₽", 0),
]
